...
void VulkanRenderPass::init(const VulkanDevice& vDevice, const VulkanSwapchain& swapchain)
{
    ...
    if (vkCreateRenderPass(vDevice.getDevice(), &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS)
    {
